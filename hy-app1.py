...
def run_program():
    ...
    try:
        colors = {
            ...
            "redtext": hexToBGR("#FF0000"),
            "paths": hexToBGR("#808080"),
            "ditches": hexToBGR("#7393B3"),
...
default_colors = {"Fairways":"#9DF595","Tee Boxes":"#85D87E","Greens":"#44964D","Background":"#FFFFFF","Trees":"#06CC55","Water":"#65FCF0","Sand":"#E6DEA5","Text & Labels":"#000000"}
